...
# Use our ruby-2.0.0@regionalindicators gemset 

default_environment['PATH']         = "/usr/local/rvm/gems/ruby-2.0.0-p247@regionalindicators/bin:/usr/local/rvm/gems/ruby-2.0.0-p247@global/bin:/usr/local/rvm/rubies/ruby-2.0.0-p247/bin:/usr/local/rvm/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:$PATH"
default_environment['GEM_HOME']     = "/usr/local/rvm/gems/ruby-2.0.0-p247@regionalindicators"
default_environment['GEM_PATH']     = "/usr/local/rvm/gems/ruby-2.0.0-p247@regionalindicators:/usr/local/rvm/gems/ruby-2.0.0-p247@global"
...
namespace :deploy do
  ...
  task :stop, except: { no_release: true } do
    run "kill -s QUIT `cat /tmp/unicorn.regionalindicators.pid`"
  end
